    ...
    loadEmbeddedTranslations() {
        this.translations = {
            en: {
                ...
                'hero-subtitle': 'Learn to integrate Bitcoin and Monero wallets with secure escrow systems',
                'hero-description': 'A comprehensive 3-phase approach to crypto development, covering everything from database design to frontend implementation. Perfect for developers looking to build secure, privacy-focused cryptocurrency payment systems.',
                ...
                'node-hero-description': 'Follow step-by-step guides covering everything from server procurement to blockchain synchronization. Perfect for those seeking sovereignty and privacy through self-hosted infrastructure.',
            ...
            nl: {
                ...
                'hero-subtitle': 'Leer Bitcoin en Monero wallets integreren met veilige escrow systemen',
                'hero-description': 'Een uitgebreide 3-fase aanpak voor crypto ontwikkeling, van database ontwerp tot frontend implementatie. Perfect voor ontwikkelaars die veilige, privacy-gerichte cryptocurrency betalingssystemen willen bouwen.',
                ...
                'node-hero-description': 'Volg stap-voor-stap gidsen die alles behandelen van server aanschaf tot blockchain synchronisatie. Perfect voor degenen die soevereiniteit en privacy zoeken door zelf-gehoste infrastructuur.',
            ...
            fr: {
                ...
                'hero-subtitle': 'Apprenez à intégrer les portefeuilles Bitcoin et Monero avec des systèmes d\'entiercement sécurisés',
                'hero-description': 'Une approche complète en 3 phases pour le développement crypto, couvrant tout de la conception de base de données à l\'implémentation frontend. Parfait pour les développeurs cherchant à construire des systèmes de paiement cryptocurrency sécurisés et axés sur la confidentialité.',
                ...
                'node-hero-description': 'Suivez des guides étape par étape couvrant tout de l\'approvisionnement de serveur à la synchronisation blockchain. Parfait pour ceux qui recherchent la souveraineté et la confidentialité grâce à une infrastructure auto-hébergée.',
